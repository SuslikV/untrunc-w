...
typedef struct {
  unsigned int    known_atom_name;
  unsigned int    known_parent_atoms[5]; //max known to be tested
...
AtomDefinition knownAtoms[] = {
    ...
    {'<()>',	{'_ANY'},	    UNKNOWN_ATOM_TYPE, UKNOWN_REQUIREMENTS,	UNKNOWN_ATOM },      //our unknown atom (self-defined)
    {'ftyp',	{'FILE'},			CHILD_ATOM,				REQUIRED_ONCE,				SIMPLE_ATOM },
    {'moov',	{'FILE'},			PARENT_ATOM,			REQUIRED_ONCE,				SIMPLE_ATOM },
    {'mdat',	{'FILE'},			CHILD_ATOM,				OPTIONAL_MANY,				SIMPLE_ATOM },
    {'pdin',	{'FILE'},			CHILD_ATOM,				OPTIONAL_ONCE,				VERSIONED_ATOM },
    {'moof',	{'FILE'},			PARENT_ATOM,			OPTIONAL_MANY,				SIMPLE_ATOM },
    ...
    {'mfra',	{'FILE'},			PARENT_ATOM,			OPTIONAL_ONCE,				SIMPLE_ATOM },
    {'tfra',	{'mfra'},						CHILD_ATOM,				OPTIONAL_ONE,					VERSIONED_ATOM },
    {'mfro',	{'mfra'},						CHILD_ATOM,				REQUIRED_ONE,					VERSIONED_ATOM },
    {'free',	{'_ANY'},			CHILD_ATOM,				OPTIONAL_MANY,				SIMPLE_ATOM },
    {'skip',	{'_ANY'},			CHILD_ATOM,				OPTIONAL_MANY,				SIMPLE_ATOM },
    {'uuid',	{'_ANY'},			CHILD_ATOM,				REQUIRED_ONCE,				EXTENDED_ATOM },
    ...
    {'meta',	{'FILE', 'moov', 'trak', 'udta'},	DUAL_STATE_ATOM, OPTIONAL_ONE, VERSIONED_ATOM },			//optionally contains info
    ...
    {'esds',	{'SAMP'},		CHILD_ATOM,				REQUIRED_ONE,					SIMPLE_ATOM },         //multiple parents; keep 3rd from end; manual return
    {'(..)',	{'ilst'},						PARENT_ATOM,		  OPTIONAL_ONE,			    SIMPLE_ATOM },         //multiple parents; keep 2nd from end; manual return
    {'data',	{'ITUN'},	CHILD_ATOM,			PARENT_SPECIFIC,			VERSIONED_ATOM }       //multiple parents
};

int atomsCount = 175; //knownAtoms size
